      ...
      <div className="container-eng">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="label-engineering">Resistance Mechanics</span>
          </div>
          <h2
        ...
        <div className="grid md:grid-cols-2 gap-16 mb-20">
          ...
          >
            <div>
              <div className="label-engineering mb-4">Boundary Layer Development</div>
              <div className="p-6 border border-[var(--color-border)] bg-[var(--color-bg-alt)]">
                <BoundaryLayerDiagram />
              </div>
            </div>
            <div>
              <div className="label-engineering mb-4">Laminar → Turbulent Transition</div>
              <div className="p-6 border border-[var(--color-border)] bg-[var(--color-bg-alt)]">
