...
export default function FlowVisualizationSection() {
  ...
  const MODES: { id: FlowMode; label: string; desc: string }[] = [
    { id: 'laminar',   label: 'Laminar Flow',    desc: 'Orderly parallel streamlines. Low Re. Minimal mixing.' },
    { id: 'turbulent', label: 'Turbulent Flow',   desc: 'Chaotic vortices. High Re. Increased friction losses.' },
    { id: 'boundary',  label: 'Boundary Layer',   desc: 'Velocity gradient from wall to free stream. δ(x) growth.' },
  ]
      ...
      <div className="container-eng">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="label-engineering">Interactive Flow Visualization</span>
          </div>
