      ...
      <div className="container-eng">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="label-engineering">Real System Examples</span>
          </div>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="p-6 border border-[var(--color-border)]">
              <div className="label-engineering mb-3">Engineering Insight</div>
            ...
            {/* Total losses visual */}
            <div className="p-6 border border-[var(--color-border)]">
              <div className="label-engineering mb-4">Loss Distribution</div>
